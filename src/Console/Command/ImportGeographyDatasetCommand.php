...
namespace PrimeKit\LaravelCountryDatasetImporter\Console\Command;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Http;
use PrimeKit\LaravelCountryDatasetImporter\Models\City;
use PrimeKit\LaravelCountryDatasetImporter\Models\Country;
use PrimeKit\LaravelCountryDatasetImporter\Models\Region;
use PrimeKit\LaravelCountryDatasetImporter\Models\State;
use PrimeKit\LaravelCountryDatasetImporter\Models\SubRegion;

class ImportGeographyDatasetCommand extends Command
{
    ...
    private function importRegions()
    {
        ...
        $data = Http::get('https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/refs/heads/master/json/regions.json')
            ->object();
    ...
    private function importSubRegions()
    {
        ...
        $data = Http::get('https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/refs/heads/master/json/subregions.json')
            ->object();
    ...
    private function importCountries()
    {
        ...
        $data = Http::get('https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/refs/heads/master/json/countries.json')
            ->object();
    ...
    private function importStates()
    {
        ...
        $data = Http::get('https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/refs/heads/master/json/states.json')
            ->object();
    ...
    private function importCities()
    {
        ...
        $data = Http::get('https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/refs/heads/master/json/cities.json')
            ->object();
